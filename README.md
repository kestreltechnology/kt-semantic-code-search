...
0.717385954101496        : org.spongycastle.pqc.math.linearalgebra.IntegerFunctions.floatPow(F,I)F (bitcoinj-core-0.14.7-bundled.jar)
0.717385954101496        : org.apache.commons.math.util.ContinuedFraction.evaluate(D,D,I)D (commons-math-2.2.jar)
0.717385954101496        : cern.colt.matrix.tdouble.algo.decomposition.DenseDoubleEigenvalueDecomposition.tql2()V (parallelcolt-0.10.1.jar)
0.717385954101496        : org.bouncycastle.pqc.math.linearalgebra.IntegerFunctions.floatPow(F,I)F (bcprov-jdk15on-1.54.jar)
0.717385954101496        : cern.colt.matrix.linalg.EigenvalueDecomposition.tql2()V (colt-1.2.0.jar)
0.717385954101496        : org.apache.commons.math.linear.EigenDecompositionImpl.findEigenVectors([[D)V (commons-math-2.2.jar)
0.717385954101496        : org.apache.commons.math.optimization.general.LevenbergMarquardtOptimizer.doOptimize()VectorialPointValuePair (commons-math-2.2.jar)
0.717385954101496        : cern.jet.stat.tdouble.DoubleDescriptive.moment(I,D,I,[D)D (parallelcolt-0.10.1.jar)
0.717385954101496        : flanagan.integration.RungeKutta.fehlberg(DerivnFunction,D,[D,D,D,D,D,I)[D (flanagan.jar)
0.717385954101496        : flanagan.integration.RungeKutta.cashKarp(DerivnFunction,D,[D,D,D,D,D,I)[D (flanagan.jar)
0.717385954101496        : cern.colt.matrix.tfloat.algo.decomposition.DenseFloatEigenvalueDecomposition.tql2()V (parallelcolt-0.10.1.jar)
0.717385954101496        : org.apache.commons.math.random.RandomDataImpl.nextPoisson(D)L (commons-math-2.2.jar)
0.717385954101496        : org.apache.commons.math.estimation.LevenbergMarquardtEstimator.estimate(EstimationProblem)V (commons-math-2.2.jar)
0.717385954101496        : flanagan.analysis.Stat.contFract(D,D,D)D           (flanagan.jar)
0.717385954101496        : cern.jet.stat.Descriptive.moment(I,D,I,[D)D        (colt-1.2.0.jar)
0.6843598358934545       : cern.jet.random.tdouble.PoissonSlow.logGamma(D)D   (parallelcolt-0.10.1.jar)
0.6843598358934545       : cern.jet.random.PoissonSlow.logGamma(D)D           (colt-1.2.0.jar)
0.6843598358934545       : flanagan.analysis.Stat.gamma(D)D                   (flanagan.jar)
0.6843598358934545       : flanagan.analysis.Stat.logGamma(D)D                (flanagan.jar)
0.6680282904614404       : cern.jet.random.tdouble.ChiSquare.nextDouble(D)D   (parallelcolt-0.10.1.jar)
	```
...
Loading the corpus ...
Postings files loaded/not loaded: 0/1943 (  0.0% loaded)
Completed in 2.519688844680786 secs


Constructing the query matrices ...
Creating a 531376 by 1 matrix
Completed in 0.9652738571166992 secs


Term weights based on their prevalence in the corpus:
  14.183227029474285  (i > 192)            (inloop_conditions)


Most similar methods:
Hennys-MacBook-Pro:algorithms henny$ python3.4 chj_search.py xindexedfeatures_alg.jar --inloop_conditions "(i > 5)"
